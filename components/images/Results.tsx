export default function Results({ data, error }) {
  ...
  /*
    <ul className='relative grid flex-1 grid-cols-1 gap-6 overflow-y-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
      {data.items.map(item => (
        <li
        ...
        >
          <a href={'#'} className='overflow-hidden bg-black h-96'>
            ...
            <div className='h-48 p-6 bg-black'>
              ...
              <div className='flex flex-col justify-between h-full'>
                ...
                <a className='block pb-4 text-primary-light lg:hover:underline'>
                  DETAILS
                </a>
              </div>
            </div>
